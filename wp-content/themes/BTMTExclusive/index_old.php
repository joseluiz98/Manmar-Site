                ...
                <div id="div-forms">
                    ...
                    <form id="login-form">
		                <div class="modal-body">
				    		...
				    		<input style="padding: 16px 10px; border-radius: 5px;" id="login_username" class="form-control" type="text" placeholder="Name" required>
				    		<input style="padding: 16px 10px; border-radius: 5px;" id="login_password" class="form-control" type="text" placeholder="E-mail" required>
				    		<input style="padding: 16px 10px; border-radius: 5px;" id="login_password" class="form-control" type="text" placeholder="PhoneNumber" required>
                ...
                <div id="div-forms">
                    ...
                    <form id="login-form">
		                <div class="modal-body">
				    		...
				    		<input style="padding: 16px 10px; border-radius: 5px;" id="login_username" class="form-control" type="text" placeholder="Nome" required>
				    		<input style="padding: 16px 10px; border-radius: 5px;" id="login_password" class="form-control" type="text" placeholder="E-mail" required>
				    		<input style="padding: 16px 10px; border-radius: 5px;" id="login_password" class="form-control" type="text" placeholder="Telefone" required>
				    		<select class="form-control">
...
#login-modal input[type=text], input[type=password], select {
	margin-top: 10px;
}
  ...
  border-radius: 0px;
		...
		function initMap() {
			...
			contentString = '<div class="topomapa1"><img class="imgmapa img-circle" src="<?php bloginfo('stylesheet_directory'); ?>/Assets/Images/lojas/barriere.png">'+
							'<h4>Antwerpen</h4>'+
							'<p><img src="<?php bloginfo('stylesheet_directory'); ?>/Assets/Images/lojas/mapa.png">Houwerstraat 1, 2060</p></div>'+
							'<h5><img src="<?php bloginfo('stylesheet_directory'); ?>/Assets/Images/lojas/time1.png"> Opening Hours</h5>'+
							'<p class="textomapa">Monday - Friday: 9 AM - 7 PM + 1 GMT</p>'+
							'<p class="textomapa">Saturday: 10 AM - 5 PM + 1 GMT</p>'+
							'<p class="textomapa">Sunday: Closed</p>';
