...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/Assets/Css/SpryValidationSelect.css">
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/Assets/Css/SpryValidationTextarea.css">
	<link rel="stylesheet" type="text/css" href="<?php echo get_template_directory_uri(); ?>/Assets/Css/SpryValidationTextField.css">
	...
	'https://connect.facebook.net/en_US/fbevents.js');
	 fbq('init', '128694154506686'); 
	fbq('track', 'PageView');
	</script>
	<noscript>
	 <img height="1" width="1" 
	src="https://www.facebook.com/tr?id=128694154506686&ev=PageView
	&noscript=1"/>
	</noscript>
	...
	<nav class="cbp-spmenu cbp-spmenu-vertical cbp-spmenu-right">
		<div class="NavigationHeader">
			...
			<div class="SocialBlock">
				...
				<a href="http://instagram.com/btmt_be" class="SocialIcon" alt="Instagram" title="Instagram">
					<i class="fa fa-instagram fa-2x" aria-hidden="true"></i>
				</a>
				<a href="https://www.linkedin.com/company/4818297" class="SocialIcon" alt="Linkedin" title="Linkedin">
		...
		<div class="NavigationLinks">
			...
			Branches</a> -->
			<a href="#branches" class="LocateUs loginlink" >
				<?php 
				//$the_query = new WP_Query( 'page_id=406' );
