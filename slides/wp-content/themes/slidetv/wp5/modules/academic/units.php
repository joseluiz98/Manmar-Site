...
class Units {
    ...
    public function getUnits($options = array()) {

        $args = array("post_type" => "units", "orderby" => "post_title", "order" => "ASC", "posts_per_page" => -1);
    ...
    public function getListUnits($options = array()) {
        
        $data = self::getUnits($options);
        $units = array();

        while ($data->have_posts()) {
            $data->the_post();
            $units[get_the_ID()] = get_the_title();
        }
    ...
    public function getUnitById($unit_id) {
        ...
        $args = array("p" => $unit_id, 'post_type' => 'units');
    ...
    public function addCustomFields() {
        ...
        add_meta_box("unitsCustomFields", "Dados da Unidade", array(&$this, "formCustomFields"), "units", "normal", "low");
    }
